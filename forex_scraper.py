...
class ForexScraper:
    ...
    visualization.draw_graph(digraph, output_file="all_vertices_digraph2.png", size="small", edge_weights=False)
    ...
    visualization.draw_graph(filtered_digraph, output_file="filtered_digraph2.png", size="large", edge_weights=True)
